...
public class LehmerRandom : MonoBehaviour
{
    // Stores the seed for the Next methods.
        private uint _seed;

        /// <summary>
        /// Initializes a new instance of the LehmerRandom class, using a time-dependent default seed value.
        /// </summary>
        public LehmerRandom()
        {
        ...
        /// <summary>
        /// Initializes a new instance of the LehmerRandom class, using the specified seed value.
        /// </summary>
